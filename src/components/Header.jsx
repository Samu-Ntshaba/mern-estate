    ...
    <header className='bg-sky-100 shadow-md'>
        <div className=" flex justify-between items-center max-w-6xl mx-auto p-3">
            ...
            <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
                <span className='text-sky-500'>Next-Door</span>
                <span className='text-sky-700'>Dladla</span>
            </h1>
            </Link>
            <form className='bg-sky-50 p-3 rounded-lg flex items-center'>
                <input type="text" placeholder='Search...' className='bg-transparent focus:outline-none w-24 sm:w-64'/>
                <FaSearch className='text-sky-600'></FaSearch>
            </form>
            <ul className='flex gap-4'>
                ...
                <Link to='/sign-in'>
                <li className=' text-sky-700 hover:underline'>Sign In</li>
                </Link>
            </ul>
        </div>
    </header>
